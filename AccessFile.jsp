        ...
        <div id="templatemo_content" align="center" style="width: 100%">
          ...
          //  ResultSet rs =statement.executeQuery("select filename from access  where touser='"+username+"'") ;
            if(rs.next()){
        		...
        		%>  
				<table class="table table-responsive table-bordered" style="width: 75%">
	       <tr>
			...
			while(resultset.next())
             {
              ...
              <td> <%= resultset.getString("filename") %> </td>
               ...
               <td> <a href="AccessServlet?filenamedb=<%=resultset.getString("filename")%>"><input type="button" name="Download" value="Download" class="btn btn-info"></a></td>
                         </tr>
       		  <% 
             } 
